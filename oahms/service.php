...
$amount=$_POST['amt'];
$qry="insert into donate(name,gender,phnumber,mailid,address,donate,amount)values('$namesc','$gender','$contnum','$mail','$commadd','$service','$amount');";
	 ...
	 <div class="gallery-section">
			 ...
			 <div class="form-group" >
                   ...
                   <div class="form-group">
                    ...
                    <select name="service" ><option value="Food">Food</option><option value="Medical kit">Medical kit</option><option value="Fund">Fund</option></select> &nbsp;&nbsp;
                                        
                    </div>
                  <div class="form-group">
                      <label for="exampleInputEmail1">If FUND ,Please Enter Your Amount</label>
                    <input name="amt" type="text"  class="form-control" required="true" value="" placeholder="0">
